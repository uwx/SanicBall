...
namespace Sanicball.Logic
{
    ...
    public class RaceManager : MonoBehaviour
    {
        ...
        //Properties
        public System.TimeSpan RaceTime => System.TimeSpan.FromSeconds(raceTimer);
        ...
        public System.Collections.ObjectModel.ReadOnlyCollection<RacePlayer> Players => new System.Collections.ObjectModel.ReadOnlyCollection<RacePlayer>(players);
        ...
        private void CreateBallObjects()
        {
            ...
            {
                //Create player UI
                var playerUIObject = Instantiate(playerUIPrefab);
                var playerUI = playerUIObject.GetComponentInChildren<PlayerUI>();
